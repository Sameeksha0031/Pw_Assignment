...
import com.example.physics_wallah_assignment.apiCalling.PokemonListResponse
    ...
    Box(modifier = Modifier
        ...
        Column {
            Text(
                ...
                text = "Pokemon List", color = Color.Yellow,
...
fun CardViewForList(
    ...
    Card(modifier = Modifier
        ...
        Row(Modifier.fillMaxWidth().padding(20.dp),
            ...
            Text(
                modifier = Modifier,
                text = character.name.capitalFirstLetter(character.name), color = Color.Blue,
